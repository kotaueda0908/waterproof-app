...
export const CARDS: Card[] = [
  ...
  // ★ ノーマル追加
  { id: 43, name: '雑工・大友',               rarity: 1, attribute: '土', tribe: '雑工',        skills: { 施工力: 18, 根性: 30, 雨耐性: 20, 臭い: 55, 酒量: 65 }, effect: '何でもやります！現場の雑用から謎の力仕事まで、とにかく体を動かす男。',                                               atk: 450,  def: 350 },

  // ★★ アンコモン追加
  { id: 44, name: '雲隠れ・タケシ',           rarity: 2, attribute: '風', tribe: '逃げ足職人',   skills: { 施工力: 30, 根性: 10, 雨耐性: 70, 臭い: 35, 酒量: 50 }, effect: 'ちょっとトイレ…を最後に消えた男。現場での目撃情報はゼロ。',                                                     atk: 1200, def: 1800 },
  { id: 45, name: 'ハツリ屋・津嘉山',         rarity: 2, attribute: '鉄', tribe: '解体職人',     skills: { 施工力: 65, 根性: 70, 雨耐性: 50, 臭い: 60, 酒量: 72 }, effect: 'コンクリートを叩き壊すことに人生を捧げた男。そのハツリ音は近隣クレームの元。',                                   atk: 1800, def: 1100 },

  // ★★★ レア追加
  { id: 46, name: '設計士のジジイ・権藤',     rarity: 3, attribute: '土', tribe: '謎の設計士',   skills: { 施工力: 60, 根性: 55, 雨耐性: 45, 臭い: 40, 酒量: 60 }, effect: '壁周りをカラカラするためだけに設計を学んだ男。その設計図には必ず壁を叩く工程が含まれている。',              atk: 1600, def: 2000 },
  { id: 47, name: '偽親方・野呂',             rarity: 3, attribute: '風', tribe: '偽親方',       skills: { 施工力: 40, 根性: 50, 雨耐性: 35, 臭い: 62, 酒量: 78 }, effect: '職長でもないのにヘルメットに「親方」とマジックで書いた男。若手には畏敬の念を持たれている。',              atk: 1900, def: 1700 },
