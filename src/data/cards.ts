...
export const CARDS: Card[] = [
  ...
  { id: 42, name: '塗装神・土橋',           rarity: 5, attribute: '炎', tribe: '伝説の塗装職人', skills: { 施工力: 99, 根性: 99, 雨耐性: 97, 臭い: 88, 酒量: 96 }, effect: '一度塗れば百年持つ。土橋が手がけた壁は嵐も台風も寄せつけない。業界の神と呼ばれる男。', atk: 4200, def: 3800 },
]
